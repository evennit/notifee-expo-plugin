...
| `enableCommunicationNotifications` | optional     | Will automatically add the Communication Notifications capability and also add INSendMessageIntent to the NSUserActivityTypes. Disabled by default.                                                                                                                                                                                                                           |

## Readme of OneSignal-Expo-Plugin...
