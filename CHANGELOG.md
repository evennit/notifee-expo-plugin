...
- Adapted the plugin to work with Notifee instead
- Add `enabledCommunicationNotifications` to the configuration option of the plugin, which automatically enable Communication Notifications capability for you and adds which allows an app to specify a custom iOS Notification Service Extension.
